...
public class ProductsPage {
	...
	private By deliveryOptions = By.xpath("//td/span/div/ul/li/a/label/input");
	private By activeDelivery = By.xpath("//li[@class='active']");
	private By headerCheckbox = By.xpath("//th[@class='check-th']");
	private By clearSelection = By.xpath("//a[text()='Clear Selection']");
	private By checkboxList = By.xpath("//label[contains(@for,'item_checkbox')]");
	...
	public WebElement activeDelivery() {
		return driver.findElement(activeDelivery);
	}
