...
import com.pages.Appointment;
import com.pages.Bookappointmentpage;
import com.pages.BookingconfigPage;
import com.pages.Configurationpage;
import com.pages.Customer;
import com.pages.Customer_info;
...
public class loginstepdef {
	...
	public void verify_retailer_able_to_configure_petType_from_the_retailer_dashboard() throws Throwable
	{	
		 WebElement ele1 = driver.findElement(By.xpath("//h5[text()='New Pet Type']"));
		    String str=ele1.getText();
		    String str1="New Pet Type";
...
//	}
	...
	{	
	 ...
	 @Then("^user click on booking tab$")
	  public void click_on_booking_tab() throws Throwable {
	        
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		 Rdb=new Retailerdashboardpage(driver);
		  Rdb.user_click_booking().click();
			   Thread.sleep(3000);
		    	
		    }
	 @Then("^user click on schedule tab$")
	  public void click_on_schedule_tab() throws Throwable {
	        
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		 Rdb=new Retailerdashboardpage(driver);
		  Rdb.user_click_schedule().click();
			   Thread.sleep(3000);
		    	
		    }
	 @Then("^Select the appointment booked$")
	    public void select_the_appointment_booked() throws Throwable {
	        
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
        SC=new schedule(driver);
        SC.user_select_date().click();
	 ...
	 @Then("^Check whether New Appointment button is displayed$")
	    public void check_whether_new_appointment_button_is_displayed() throws Throwable {
	        
		  Thread.sleep(5000);
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  String str="New Appointment";
		  WebElement title = driver.findElement(By.xpath("//button[text()='New Appointment']"));			 
	 ...
	 @Then("^Click on the New Appointment button$")
	    public void click_on_the_new_appointment_button() throws Throwable {
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		 Ap=new Appointment(driver);
		  Ap.user_click_appointment().click();
			   Thread.sleep(3000);
		    	
		    }
	  @Then("^Check the book a schedule page is shown$")
	    public void check_the_book_a_schedule_page_is_shown() throws Throwable {
	        
		  Thread.sleep(5000);
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  String str="Book Appointment";
		  WebElement title = driver.findElement(By.xpath("//h5[text()='Book Appointment']"));			 
		  String str1 = title.getText();
		  //Assert.assertEquals(text1, text2);		
		  try{
	          Assert.assertEquals(str, str1);
	  ...
	  @Then("^Select Customer from the drop down$")
	    public void select_customer_from_the_drop_down() throws Throwable {
	  ...
	  @Then("^Verify Service Details Section is displayed$")
	    public void verify_service_details_section_is_displayed() throws Throwable {
		
		 BAP=new Bookappointmentpage(driver);
	    WebElement ele1 = driver.findElement(By.xpath("//h5[text()='Service Details']"));
	    String str=ele1.getText();
	    String str1="Service Details";
	    try{
	          Assert.assertEquals(str1, str);
	          System.out.println(" - passed");
	     }catch(AssertionError e){
	  ...
	  @Then("^Choose Service Type dropdown is displayed$")
	    public void choose_service_type_dropdown_is_displayed() throws Throwable {
		
		 BAP=new Bookappointmentpage(driver);
         Thread.sleep(5000);
         BAP.user_Select_service_type().click();
         Thread.sleep(3000);
	    BAP.user_Select_service().click();
	    Thread.sleep(3000);
	}
	  
	  @Then("^Choose Service Namedropdown is displayed$")
	    public void choose_service_namedropdown_is_displayed() throws Throwable {
		BAP=new Bookappointmentpage(driver);
        Thread.sleep(5000);
        BAP.user_service_name().click();
       Thread.sleep(3000);
	    BAP.user_select_service_name().click();
	    Thread.sleep(4000);
	    BAP.user_click_on_attandent().click();
	    Thread.sleep(3000);
	    BAP.user_select_attandent().click();
	    Thread.sleep(3000); 
	    BAP.user_select_timeSlot().click();
//	    Random randomDays = ThreadLocalRandom.current();
//	    LocalDateTime date = LocalDateTime.now().plusDays(randomDays.nextInt(365) + 1);
//	    System.out.println(date); 
	    BAP.user_select_date().click();
	    Thread.sleep(3000);
	    BAP.user_select_time().click();
	    Thread.sleep(3000);
	    BAP.user_Enter_tip_amount().sendKeys("20");
	
	}
	  @Then("^Verify Pet details section is displayed$")
	    public void verify_pet_details_section_is_displayed() throws Throwable {
	        
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  BAP=new Bookappointmentpage(driver);
	        Thread.sleep(5000);
	       BAP.user_click_on_petdetails().click();
	       Thread.sleep(3000);
		  WebElement ele1 = driver.findElement(By.xpath("//h5[text()='Pet Details']"));
		  String str1="Pet Details";
		    String str=ele1.getText();		    
		    try{
		          Assert.assertEquals(str1, str);
		          System.out.println("Shown pet Details");
		     }catch(AssertionError e){
		          System.out.println(" - failed");
	  ...
	  @Then("^Select a Pet from Pet dropdown$")
	    public void select_a_pet_from_pet_dropdown() throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
       Thread.sleep(5000);
       BAP.user_select_pet().click();
       Thread.sleep(3000);
       BAP.user_Select_pet_name().click();
       Thread.sleep(3000);
       BAP.user_click_Temperament().click();
       Thread.sleep(3000);
       BAP.user_Select_temperament().click();
       Thread.sleep(3000);
       BAP.user_click_hairlength().click();
       Thread.sleep(3000);
	  ...
	  @Then("^Verify Other Details section is displayed$")
	    public void verify_other_details_section_is_displayed() throws Throwable {
	        
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  BAP=new Bookappointmentpage(driver);
	        Thread.sleep(5000);
	       BAP.user_click_on_otherdetails().click();
	       Thread.sleep(3000);
		  WebElement ele1 = driver.findElement(By.xpath("//h5[text()='Other Details']"));
		  String str1="Other Details";
		    String str=ele1.getText();		    
		    try{
		          Assert.assertEquals(str1, str);
		          System.out.println("shown Other Details");
		     }catch(AssertionError e){
		          System.out.println(" - failed");
	  ...
	  @Then("^Enter Vet information$")
	    public void enter_vet_information() throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
		 BAP.user_enter_vetname2().clear();
		  BAP.user_enter_vetname2().sendKeys("testdog");
		  Thread.sleep(3000);
	  ...
	  @Then("^Enter the Emergency Contact information$")
	    public void enter_the_emergency_contact_information() throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
		 BAP.user_enter_emergency().clear();
		  BAP.user_enter_emergency().sendKeys("testdog2");
		  Thread.sleep(3000);
		  BAP.user_enter_emergency_number().clear();
		  BAP.user_enter_emergency_number().sendKeys("9896565983");
		  JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("window.scrollBy(0,450)", "");
	}
	  @Then("^Enter Feeding information$")
	    public void enter_feeding_information() throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
		BAP.user_click_how_many_times_food().click();
		Thread.sleep(3000);
		BAP.user_click_service_auto_booked().click();
		Thread.sleep(3000);
	}
	  @Then("^Check the option whether you need recurring option or not optional$")
	    public void check_the_option_whether_you_need_recurring_option_or_notoptional() throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
		BAP.user_click_enter_number_of_time().sendKeys("5");
		Thread.sleep(3000);
		BAP.user_click_on_booknow().click();
	}
	
	  @Then("^Verify a pop up is shown$")
	    public void verify_a_pop_up_is_shown() throws Throwable {
		  ...
		  BAP=new Bookappointmentpage(driver);
	        Thread.sleep(5000);
	       Thread.sleep(3000);
		  WebElement ele1 = driver.findElement(By.xpath("(//h5[text()='Service Details'])[2]"));
		  String str1="Service Details";
		    String str=ele1.getText();		    
		    try{
		          Assert.assertEquals(str1, str);
		          System.out.println("POP is Shown");
		     }catch(AssertionError e){
		          System.out.println(" - failed");
	  ...
	  @Then("^Click on Checkout to confirm Booking.$")
	    public void click_on_checkout_to_confirm_booking()throws Throwable { 
		
		 BAP=new Bookappointmentpage(driver);
		 JavascriptExecutor js = (JavascriptExecutor) driver;
		 js.executeScript("window.scrollBy(0,650)", "");
		 BAP.user_click_on_checkout().click();
		 Thread.sleep(3000);
		 	    
		    try { 
		         if(
		         driver.findElement(By.xpath("//div[text()='Appointment created successfully']"))!= null){
		          ...
		          if(driver.findElement(By.xpath("//div[text()='Selected pet has another appointment at selected time']"))!= null){
	...
	public void check_pet_already_having_schedule_for_appointmnet_able_to_delete() throws Throwable
	{	
		bp=new BookingconfigPage(driver);
		   bp.user_click_delete().click();
		   bp.click_yes().click();
		   Thread.sleep(3000);
		   try { 
		         if(
		         driver.findElement(By.xpath("//div[text()='Pet Type is currently used by Attendants']"))!= null){

		          System.out.println("Pet Type is currently used by Attendants");  
		                }
		         if(
				         driver.findElement(By.xpath("//div[text()='Pet Type is currently used by Venues']"))!= null){
		          ...
		          if(driver.findElement(By.xpath("//div[@class='Toastify__toast Toastify__toast--success']//div[1]"))!= null){
	  ...
	  public void click_on_customer_tab() throws Throwable {
	        
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		    CU = new Customer(driver);
		    CU.user_click_on_customer().click();
	  ...
	  public void user_search_customername() throws Throwable {
	        
	    

		  CU = new Customer(driver);
		  CU.user_Search_customer().sendKeys("Anu s");
		  CU.user_click_on_submit().click();
		   CU.user_select_on_customer().click();
	  ...
	  @Then("^Click on the menu service History$")
	    public void click_on_the_menu_service_history() throws Throwable {
		  CI = new Customer_info(driver);
		  CI.user_click_on_service_history().click();
	  ...
	  @Then("^Choose the Notes icon$")
	    public void choose_the_notes_icon() throws Throwable {
	Thread.sleep(3000);
		  JavascriptExecutor js = (JavascriptExecutor) driver;
...
// Or scroll the div by pixel number:
 ((JavascriptExecutor) driver).executeScript("arguments[0].scrollLeft += 350", scrollArea);
 Thread.sleep(5000);
 ((JavascriptExecutor) driver).executeScript("arguments[0].scrollLeft = arguments[0].offsetWidth", scrollArea);
//Or scroll the div by pixel number:
((JavascriptExecutor) driver).executeScript("arguments[0].scrollLeft -= 100", scrollArea);
 Thread.sleep(3000);
	  ...
	  @Then("^Verify Appointment id is shown on the top of the pop up$")
	    public void verify_appointment_id_is_shown_on_the_top_of_the_pop_up() throws Throwable {
	        
		    	Thread.sleep(3000);
		    	WebElement title = driver.findElement(By.xpath("//p[text()='No General Notes for this service!']"));
		    	String str="No General Notes for this service!";
		    	String str1 = title.getText();
		    	try{
			          Assert.assertEquals(str1, str);
			          System.out.println( " - pop Shown sucessfull");
			     }catch(AssertionError e){
			          System.out.println( " - failed");
	  ...
	  @Then("^Enter the Notes$")
	    public void enter_the_notes() throws Throwable {
		  ...
		  Thread.sleep(3000);
		  driver.findElement(By.xpath("//textarea[@class='form-control']")).sendKeys("add pet discription");
	  ...
	  @Then("^Submit the Notes$")
	    public void submit_the_notes() throws Throwable {
	  ...
	  @Then("^Click on the Edit Button corresponding to the Note to Edit$")
	    public void click_on_the_edit_button_corresponding_to_the_note_to_edit() throws Throwable {
		 ...
		 driver.findElement(By.xpath("(//button[text()='Edit Note'])[1]")).click();
		  ...
		  driver.findElement(By.xpath("//textarea[@class='form-control']")).clear();
		  Thread.sleep(3000);
		  driver.findElement(By.xpath("//textarea[@class='form-control']")).sendKeys("edit the notes with discription");
			   System.out.println("user click on add notes ");
	  ...
	  @Then("^Submit the Notes edit$")
	    public void submit_the_notes_edit() throws Throwable {
	  ...
	  public void user_click_on_petprofile() throws Throwable {
	  ...
	  public void user_click_on_addnewpet() throws Throwable {
	  ...
	  @Then("^check in pet type is able to view under the pet types  page$")
	    public void check_in_pet_type_is_able_to_view_under_the_pet_types_page() throws Throwable {
		   ...
		   // ps.addtoCart2().click();
	    	...
	    	WebElement title = driver.findElement(By.xpath("(//h6[text()='Select pet type']"));
	    	String str="Select pet type";
	    	String str1 = title.getText();
	    	try{
		          Assert.assertEquals(str1, str);
		          System.out.println( " - passed");
	  ...
	  @Given("^user add url$")
	  public void user_add_url() throws Throwable {
		  Base base = new Base();
	 		driver= base.getDriver2();
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
			   System.out.println("user add url");
			   driver.manage().window().maximize();
	  ...
	  @Then("^Choose the Book Appointment option$")
	    public void choose_the_book_appointment_option() throws Throwable {
		  Thread.sleep(3000);
	  ...
	  public void click_dasboard() throws Throwable {
	  ...
	  public void click_on_petprofile_addpet() throws Throwable {
		  //WebDriver driver = new ChromeDriver();
		   //driver.get("https://sandyspetstore.dev.etailpet.com/accounts/login/");
		  ...
		  JavascriptExecutor js = (JavascriptExecutor) driver;
			js.executeScript("window.scrollBy(0,450)", "");
			Thread.sleep(3000);
		  driver.findElement(By.cssSelector("a[href='/customers/booking/pet-profiles/']")).click();
	  ...
	  public void  Select_Pettype_as_testpet() throws Throwable {
		  //WebDriver driver = new ChromeDriver();
		   //driver.get("https://sandyspetstore.dev.etailpet.com/accounts/login/");
	  ...
	  public void click_on_Configuration() throws Throwable {
		   ...
		   // ps.addtoCart2().click();
			 Rdb=new Retailerdashboardpage(driver);
			  Rdb.user_click_configuration().click();
				   Thread.sleep(3000);
	  ...
	  public void click_on_Pet_type() throws Throwable {
		  Thread.sleep(3000);
	    
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  C=new Configurationpage(driver);
		  C.user_click_petType().click();
			   Thread.sleep(3000);
		  
		  System.out.println("user click on pet");
		  Thread.sleep(3000);
		    	
		    }
	  
	  @Then("^verify  pet type able to deactive from the pet list$")
	  public void check_pet_type() throws Throwable {
		  ...
		  PT.user_click_on_switch().click();
		    	...
		    	String str="Pet type updated successfully";
		    	String str1 = title.getText();
		    	try{
			          Assert.assertEquals(str1, str);
			          System.out.println( " - passed");
	  ...
	  public void check_pet_type_able_activate() throws Throwable {
	  ...
	  public void click_on_configuration() throws Throwable {
		   ...
		   // ps.addtoCart2().click();
		  C=new Configurationpage(driver);
		  C.user_click_configuration().click();
			   Thread.sleep(3000);
	  ...
	  public void click_on_weight() throws Throwable {
	        
		  Thread.sleep(3000);
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		  PW=new PetWeight(driver);
		  PW.user_click_on_weight().click();
		    	Thread.sleep(4000);
	  ...
	  public void Update_weight_range() throws Throwable {
         ...
         Thread.sleep(3000);
         PW.user_enter_min_weight().clear();
         PW.user_enter_min_weight().sendKeys("2");	
         Thread.sleep(3000);
         PW.user_enter_min_weight().clear();
	  ...
	  public void user_click_on_save_button() throws Throwable {
		  ...
		  Thread.sleep(3000);
		   ...
		   // ps.addtoCart2().click();
		  PW=new PetWeight(driver);
		  PW.user_click_on_save().click();
         Thread.sleep(3000);
		    	
		    }
	  @Then("^Verify all options are updating based on the updation from the pet type configuration$")
	    public void verify_all_options_are_updating_based_on_the_updation_from_the_pet_type_configuration() throws Throwable {
	        
		    //ps=new ProductStore (driver);
		   // ps.addtoCart2().click();
		
		  WebElement ele1 = driver.findElement(By.xpath("//div[text()='Pet type updated successfully']"));
		  String str1="Pet type updated successfully";
		    String str=ele1.getText();		    
		    try{
		          Assert.assertEquals(str1, str);
		          System.out.println(" - passed");
	  ...
	  public void user_insert_image() throws Throwable {
		  ...
		  Thread.sleep(3000);
		   ...
		   // ps.addtoCart2().click();
		  PT=new petType(driver);
		  PT.user_enter_petimage().sendKeys("C:\\Users\\manis\\OneDrive\\Desktop\\istockphoto-1161871064-612x612.jpg");
	  ...
	  public void user_click_on_nextbutton_weightpage() throws Throwable {
		  ...
		  String text2 = "Do you wish to collect weight information for this pet type?";
		  //Assert.assertEquals(text1, text2);		
		  try{
	          Assert.assertEquals(text1, text2);
	          System.out.println( " - passed");
		  ...
		  public void user_click_on_nextbutton_weightpage_options_no() throws Throwable {
		        
			  Thread.sleep(3000);
			    //ps=new ProductStore (driver);
			   // ps.addtoCart2().click();
			  PW=new PetWeight(driver);
			  PW.user_click_next().click();
			  Thread.sleep(3000);
		  ...
		  @Then("^verify without specifying the data$")
	        public void user_verify_retailer_clickon_buttonwothout_specifyingdata() throws Throwable {
		     ...
		     Thread.sleep(3000);
			  ...
			  Thread.sleep(3000);
			  String text6 = "Please Enter hair Length like Short/Medium/Long";
			  //Assert.assertEquals(text1, text2);		
			  try{
		  ...
		  @Then("^Verify retailr is able  active and deactive the hair length options$")
		    public void verify_retailr_is_able_active_and_deactive_the_hair_length_options() throws Throwable {
			    //ps=new ProductStore (driver);
			   // ps.addtoCart2().click();
			  PHL=new petHairLength(driver);
		  ...
		  @Then("^Verify after clicking on the next button retailer is directing to hair texture section$")
		    public void verify_after_clicking_on_the_next_button_retailer_is_directing_to_hair_texture_section() throws Throwable {
		        
			  Thread.sleep(3000);
			    //ps=new ProductStore (driver);
			   // ps.addtoCart2().click();
			  PHL=new petHairLength(driver);
			  PHL.user_click_on_next().click();
			  Thread.sleep(3000);
			  ...
			  String text3 = title.getText();
			  String text4 = "Set the Hair Texture options you wish to offer for Pet Parents to describe this labsdogs";
			  //Assert.assertEquals(text1, text2);		
			  try{
		          Assert.assertEquals(text3, text4);
		          System.out.println( " - passed");
		  ...
		  @Then("^Verify retiler is able to give hair texture with new option by clicking on the add new  texture$")
		    public void verify_retiler_is_able_to_give_hair_texture_with_new_option_by_clicking_on_the_add_new_texture() throws Throwable {
		  ...
		  @Then("^Verify retailer by clicking on the next button will directing to deisred hair length page and pet name in the top$")
		    public void verify_retailer_by_clicking_on_the_next_button_will_directing_to_deisred_hair_length_page() throws Throwable {
			  ...
			  String text3 = title.getText();
			  String text4 = "Pet Type: labsdogs - Desired Hair Length";
			  //Assert.assertEquals(text1, text2);		
			  try{
		          Assert.assertEquals(text3, text4);
		          System.out.println( " - passed");
		  ...
		  @Then("^Verify retailer is able to give blades options$")
		    public void verify_retailer_is_able_to_give_blades_options() throws Throwable {
			  ...
			  Thread.sleep(3000);
			  PCB.user_enter_value_on_blades().sendKeys("5");
			  Thread.sleep(3000);
			  PCB.user_click_on_add_blades();
			  Thread.sleep(3000);
			  WebElement title = driver.findElement(By.xpath("//p[text()='I would like to maintain internal notes on combs and blades available to use for this pet type']"));
			  String text3 = title.getText();
			  String text4 = "I would like to maintain internal notes on combs and blades available to use for this pet type";
		  ...
		  @Then("^Verify user enter vaccine name clickanadd create vaccine option adminstration,expiry and document uploadcheckboxes  based retailer wish ableto configureit$")
		    public void verify_user_enter_vaccine_name_clickanadd_create_vaccine_option_adminstrationexpiry_and_document_uploadcheckboxes_based_retailer_wish_ableto_configureit() throws Throwable {
			  ...
			  Thread.sleep(3000);
			   ...
			   // ps.addtoCart2().click();
			  PVR=new pet_Vaccination_Records(driver);
			  PVR.user_enter_vaccination_type().sendKeys("test");
			  Thread.sleep(3000);
		  ...
		  @Then("^Verify by seelcting the third  option - input filed will generated for giving the data$")
		    public void verify_by_seelcting_the_third_option_input_filed_will_generated_for_giving_the_data() throws Throwable {
			  ...
			  Thread.sleep(3000);
			  PA.user_enter_allergies().sendKeys("test1");
			  Thread.sleep(3000);
		  ...
		  @Then("^Verify by add vet information by select yes$")
		    public void verify_by_add_vet_information_by_select_yes() throws Throwable {
			  ...
			  Thread.sleep(3000);
			  PV.user_enter_vet().sendKeys("test12");
			  Thread.sleep(3000);
		  ...
		  @Then("^Verify retailer is selected the option as yes -able to document upload$")
			  ...
			  Thread.sleep(3000);
			  PD.user_click_on_addnewDocs().click();
			  Thread.sleep(3000);
			  PD.user_enter_docs().sendKeys("test25");
			  Thread.sleep(3000);
			  PD.user_click_on_add().click();
			  Thread.sleep(3000);
			  WebElement title = driver.findElement(By.xpath("//p[text()='I also need to get the following other docs for this pet type']"));
			  String text3 = title.getText();
			  String text4 = "I also need to get the following other docs for this pet type";
		 ...
		 Thread.sleep(3000);
		 PEC.user_enter_emergency_contact().sendKeys("testest");
		 Thread.sleep(3000);
		 PEC.user_click_on_add().click();
		  ...
		  @Then("^Verify by pet created is successfully or not$")
		    public void verify_by_pet_created_is_successfully_or_not() throws Throwable {
			    ...
			    try { 
			         if(
			         driver.findElement(By.xpath("//div[text()='Pet type added successfully!']"))!= null){
			          ...
			          if(driver.findElement(By.xpath("//div[text()='Pet type already exist with name labsdogs']"))!= null){
...
//  l=new LoginPage(driver);
//   l.enter_username().sendKeys("Rahul@etailpet.com");
//	  
	    	Thread.sleep(5000);
...
//  l=new LoginPage(driver);
//  l.enterpassword().sendKeys("123456!");
 	Thread.sleep(5000);
